 ...
 * @since 1.0a RC1
 **/
define('COMMUNITY_NAME', 'Rolling Thunder Networks CAD/MDT');
 ...
 **/
define('AUTH_KEY',         ',Iyk?z4Ob <gf6cZt`~ z4f1$&_KeG<!m9YSw-oD03#+KWQ-9jP*Kf/Pq -61!]<');
define('SECURE_AUTH_KEY',  '|#3U4Cv.`qWr>MW=cdH}X(6+Kbc|#Pu|w,1rPXN|})#@XUi~j-2)xFl1nzQxmwY^');
define('LOGGED_IN_KEY',    '(*+p zxW1%W*gZhP7|@pTF4#@]k2G[bPW+X@F2+Yox*am%7MRejZmb#fxJV4!EQp');
define('NONCE_KEY',        '|o9DAP?etvUZox+yOE8m/;FwK;J:5HwpFfI@DT!DaA+3j/D_|.0k:N1d5^|XCV:D');
define('AUTH_SALT',        'W+uz`ly^]RFjLe=mqWToNi|-XkcqyX~7x)O$q+$oO90l,y2^|[:7HpNCw-/!Inj3');
define('SECURE_AUTH_SALT', '0]%/KkLd1Iy:tw2qwL_Gwf.CIMWp7&ViX09.}N]weaMf3Wdkc@+tV/+#<4**vgJL');
define('LOGGED_IN_SALT',   '+`kL+I9^hqP$4&IR:5d^;&%|%e[-e;5(23+w/lSw^$A(frb6)>9+=kctHNXk$Q`e');
define('NONCE_SALT',       'm7E1%Qmp <.]xuDc_.Cbf3jn_$>P7+CFheCR+=f+SW+J2_2X4h!/H&CDfDQto&ql');
...
/**#@+
  ...
  * @since OpenCAD version 0.2.3
  **/
define('MODERATOR_SUSPEND_WITHOUT_REASON', false);
